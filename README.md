...
*An alternative to using SSDT-PLUG-ALT is flashing a [modified version](https://docs.chrultrabook.com/docs/installing/macos-firmware.html) of Coreboot and using the normal SSDT-PLUG from SSDTTime.
